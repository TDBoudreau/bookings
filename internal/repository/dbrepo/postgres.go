...
// InsertReservation inserts a reservation into the database and returns the id
...
// SearchAvailabilityByDatesForAllRooms returns a slice of available rooms, if any for given date range
