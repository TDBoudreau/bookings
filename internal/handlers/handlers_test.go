...
func TestRepository_PostReservation(t *testing.T) {
	...
	postedData.Add("phone", "222-333-5555")
	postedData.Add("start_date", "2050-12-01")
	postedData.Add("end_date", "2050-12-05")
	...
	if err != nil {
		t.Error("error clearing test session")
	}
	//handler = http.HandlerFunc(Repo.PostReservation)
	handler.ServeHTTP(rr, req)
	if rr.Code != http.StatusTemporaryRedirect {
...
func TestRepository_PostAvailability(t *testing.T) {
	...
	// testing dates, end < start
	postedData = url.Values{}
	postedData.Add("start", "2040-01-02")
	postedData.Add("end", "2040-01-01")
